...
function mouse_move(e) {
  ...
  ball.style.top = ball_data.y + "px";
   ...
   shadow_ball.style.left = x_input.value + "px";
  shadow_ball.style.top = y_input.value + "px";
...
// const start_scene_button = document.querySelector(".start-scene-button");
...
const simulationLoop = () => {
  ...
  // if (coor_inputs) {
  //   ball_data.x = coor_inputs[0].value;
  //   ball_data.y = coor_inputs[1].value;
