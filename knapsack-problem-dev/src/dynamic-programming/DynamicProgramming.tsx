...
import type { AlgorithmName, TAlgorithmStatus, DpAlgorithm } from "../types/IAlgorithms";
    ...
    <>
    {
      ...
      >
        ...
        >
          ...
          <p className="whitespace-nowrap ml-4">dp[{step.i}][{step.w}] = {dp[step.i][step.w]}</p>
            ...
            Array.from({ length: knapsackWeight + 2 }).map((_, ci) => {
              ...
              return (
                <motion.div
                  ...
                  duration: 1,
                  ease: "easeInOut" }}
                  animate = {( status == "finished") && step.i === ri - 1 && step.w === ci - 1 ? "pulse": "static"}
                  key={`${ri}-${ci}`}
